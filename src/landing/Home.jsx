...
function Home() {
    return ( 
        <div className='flex flex-col-reverse lg:flex-row min-h-[100vh] transition-all duration-300'>
            <div className='bg-night text-white min-h-[50vh] w-100vw lg:w-[60vw] xl:h-[100vh] xl:home-box flex pt-15 md:items-center'>
            ...
            <div className='bg-day lg:w-[40vw] h-fit lg:h-[100vh] flex justify-center md:items-center xl:home-box'>
